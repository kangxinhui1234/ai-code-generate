...
public class CodeGeneratorNode {
    ...
    public static AsyncNodeAction<MessagesState<String>> create() {
        return node_async(state -> {
            ...
            log.info("开始生成代码，类型: {} ({})", generationType.getType(), generationType.getMsg());
            ...
            // 根据类型设置生成目录
            String generatedCodeDir = String.format("%s/%s_%s", AppConstant.CODE_OUTPUT_ROOT_DIR, generationType.getType(), appId);
