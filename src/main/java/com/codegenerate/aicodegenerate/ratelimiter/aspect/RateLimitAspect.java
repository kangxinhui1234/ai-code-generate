package com.codegenerate.aicodegenerate.ratelimiter.aspect;
...
public class RateLimitAspect {
    ...
    public void doBefore(JoinPoint point, RateLimit rateLimit) {
        ...
        if (!rateLimiter.tryAcquire(1)) {
            throw new BussessException(ErrorCode.TOO_MANY_REQUEST.getCode(), rateLimit.message());
        }
    }
    ...
    private String generateRateLimitKey(JoinPoint point, RateLimit rateLimit) {
        ...
        switch (rateLimit.limitType()) {
            ...
            case IP:
                ...
                break;
            default:
                throw new BussessException(ErrorCode.SYSTEM_ERROR.getCode(), "不支持的限流类型");
        }
